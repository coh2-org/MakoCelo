    ...
    public class Gfx
    {
        ...
        public void GFX_DrawPlayerCard(int N)
        {
            ...
            for (var t = 1; t <= 3; t++)
            {
                ...
                var personalStats = currentPlayer.PersonalStats.FirstOrDefault(x => (int)x.Faction == t && x.GameMode == GameMode.V1);
                if (personalStats != null)
                {
                    _frmMain.Main_Gfx.DrawString(personalStats.FormattedRank, fonRank, BruName, XSec[2],
                        YStart[t] + YSec[2]);
                    _frmMain.Main_Gfx.DrawString(personalStats.Wins.ToString(), fonRank, BruName, XSec[3],
                        YStart[t] + YSec[2]);
                    _frmMain.Main_Gfx.DrawString(personalStats.Losses.ToString(), fonRank, BruName, XSec[4],
                        YStart[t] + YSec[2]);
                    _frmMain.Main_Gfx.DrawString(personalStats.WinLossPercentRatio, fonRank, BruName, XSec[5],
                        YStart[t] + YSec[2]);
                }

                _frmMain.Main_Gfx.DrawString("2v2", fonRank, BruRank2, XSec[1], YStart[t] + YSec[3]);
                personalStats = currentPlayer.PersonalStats.FirstOrDefault(x => (int)x.Faction == t && x.GameMode == GameMode.V2);
                if (personalStats != null)
                {
                    _frmMain.Main_Gfx.DrawString(personalStats.FormattedRank, fonRank, BruName, XSec[2],
                        YStart[t] + YSec[3]);
                ...
                personalStats = currentPlayer.PersonalStats.FirstOrDefault(x => (int)x.Faction == t && x.GameMode == GameMode.V3);
                if (personalStats != null)
                {
                    _frmMain.Main_Gfx.DrawString(personalStats.FormattedRank, fonRank, BruName, XSec[2],
                        YStart[t] + YSec[4]);
                ...
                personalStats = currentPlayer.PersonalStats.FirstOrDefault(x => (int)x.Faction == t && x.GameMode == GameMode.V4);
                if (personalStats != null)
                {
                    _frmMain.Main_Gfx.DrawString(personalStats.FormattedRank, fonRank, BruName, XSec[2],
                        YStart[t] + YSec[5]);
            ...
            {
                tPic = (PictureBox) _frmMain.Controls["pbFact0" + t];
                _frmMain.Main_Gfx.DrawImage(tPic.Image, Xmid, YFact[t], _frmMain.LAB_Fact[t].Width,
                    _frmMain.LAB_Fact[t].Height);
                if (t == 4)
                {
                ...
                var personalStats =
                    currentPlayer.PersonalStats.FirstOrDefault(x => (int) x.Faction == t && x.GameMode == GameMode.V1);
                if (personalStats != null)
                {
                    _frmMain.Main_Gfx.DrawString(personalStats.FormattedRank, fonRank, BruName, XSec[7],
                        YStart[t] + YSec[2]);
                    _frmMain.Main_Gfx.DrawString(personalStats.Wins.ToString(), fonRank, BruName, XSec[8],
                        YStart[t] + YSec[2]);
                    _frmMain.Main_Gfx.DrawString(personalStats.Losses.ToString(), fonRank, BruName, XSec[9],
                        YStart[t] + YSec[2]);
                    _frmMain.Main_Gfx.DrawString(personalStats.WinLossPercentRatio, fonRank, BruName, XSec[10],
                        YStart[t] + YSec[2]);
                }

                _frmMain.Main_Gfx.DrawString("2v2", fonRank, BruRank2, XSec[6], YStart[t] + YSec[3]);
                personalStats =
                    currentPlayer.PersonalStats.FirstOrDefault(x => (int) x.Faction == t && x.GameMode == GameMode.V2);
                if (personalStats != null)
                {
                    _frmMain.Main_Gfx.DrawString(personalStats.FormattedRank, fonRank, BruName, XSec[7],
                        YStart[t] + YSec[3]);
                ...
                personalStats =
                    currentPlayer.PersonalStats.FirstOrDefault(x => (int) x.Faction == t && x.GameMode == GameMode.V3);
                if (personalStats != null)
                {
                    _frmMain.Main_Gfx.DrawString(personalStats.FormattedRank, fonRank, BruName, XSec[7],
                        YStart[t] + YSec[4]);
                ...
                personalStats =
                    currentPlayer.PersonalStats.FirstOrDefault(x => (int) x.Faction == t && x.GameMode == GameMode.V4);
                if (personalStats != null)
                {
                    _frmMain.Main_Gfx.DrawString(personalStats.FormattedRank, fonRank, BruName, XSec[7],
                        YStart[t] + YSec[5]);
